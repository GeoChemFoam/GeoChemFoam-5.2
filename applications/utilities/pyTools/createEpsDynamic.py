            ...
            while (i<len(lines)):
                if 'value' in lines[i]:
                    ...
                    for j in range(nbz0):
                        ...
                        iz_bz0[j]=np.floor((z-res*(zmin+startZ*r))/dz);
                    i = start_idx + nbz0  # skip ahead
                    break
                i +=1
        i +=1
            ...
            while (i<len(lines)):
                if 'value' in lines[i]:
                    ...
                    for j in range(nby0):
                        ...
                        iy_by0[j]=np.floor((y-res*(ymin+startY*q))/dy);
            ...
            while (i<len(lines)):
                if 'value' in lines[i]:
                    ...
                    for j in range(nbx0):
                        ...
                        parts = vec_line.split()
                        x, y, z = map(float, parts)
                        ix_bx0[j]=np.floor((x-res*(xmin+startX*p))/dx);
            ...
            while (i<len(lines)):
                if 'value' in lines[i]:
                    ...
                    for j in range(nbx1):
                        ...
                        parts = vec_line.split()
                        x, y, z = map(float, parts)
                        ix_bx1[j]=np.floor((x-res*(xmin+startX*p))/dx);
            ...
            while (i<len(lines)):
                if 'value' in lines[i]:
                    ...
                    for j in range(nby1):
                        ...
                        iy_by1[j]=np.floor((y-res*(ymin+startY*q))/dy);
            ...
            while (i<len(lines)):
                if 'value' in lines[i]:
                    ...
                    for j in range(nbz1):
                        ...
                        iz_bz1[j]=np.floor((z-res*(zmin+startZ*r))/dz);
                    i = start_idx + nbz1  # skip ahead
                    break
                i += 1
        i +=1
...
for j in range(0,n):
    if (eps[j]<1) and (eps[j]>2*eps_min):
      eps[j]=0
...
if (ipz>0):
    for j in range(0,nbz0):
      if (eps_bz0[j]<1) and (eps_bz0[j]>2*eps_min):
        eps_bz0[j]=0
        for ii in range (0,p1):
          for jj in range (0,q1):
            for kk in range (0,r1):
...
if (ipy>0):
    for j in range(0,nby0):
      if (eps_by0[j]<1) and (eps_by0[j]>2*eps_min):
        eps_by0[j]=0
        for ii in range (0,p1):
          for jj in range (0,q1):
            for kk in range (0,r1):
...
if (ipx>0):
    for j in range(0,nbx0):
      if (eps_bx0[j]<1) and (eps_bx0[j]>2*eps_min):
        eps_bx0[j]=0
        for ii in range (0,p1):
          for jj in range (0,q1):
            for kk in range (0,r1):
...
if (ipx<NPX-1):
    for j in range(0,nbx1):
      if (eps_bx1[j]<1) and (eps_bx1[j]>2*eps_min):
        eps_bx1[j]=0
        for ii in range (0,p1):
          for jj in range (0,q1):
            for kk in range (0,r1):
...
if (ipy<NPY-1):
    for j in range(0,nby1):
      if (eps_by1[j]<1) and (eps_by1[j]>2*eps_min):
        eps_by1[j]=0
        for ii in range (0,p1):
          for jj in range (0,q1):
            for kk in range (0,r1):
...
if (ipz<NPZ-1):
    for j in range(0,nbz1):
      if (eps_bz1[j]<1) and (eps_bz1[j]>2*eps_min):
        eps_bz1[j]=0
        for ii in range (0,p1):
          for jj in range (0,q1):
            for kk in range (0,r1):
