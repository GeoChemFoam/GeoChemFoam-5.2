...
def main(xDim, yDim, zDim, xMin, xMax, yMin, yMax, zMin, zMax, nX, nY, nZ, res,Image_name, padWidth, pores_value,solid_value, micro_por, phases ,dimension,direction, nlevel,refineStokes,NPX, NPY, NPZ, rank, output_path):
 ...
 for j in range(0,n):
    epsVal=eps[j]
    is_refined=0
    if (epsVal>poro[nlist-1]+1e-3-refineStokes*3e-3):
      is_refined=1
    else:
     for k in range(0,nlist-1):
       if (epsVal<poro[k+1]-(poro[k+1]-poro[k])*5e-3) and (epsVal> poro[k]+(poro[k+1]-poro[k])*5e-3):
         is_refined=1
    if (is_refined):
      eps[j]=0
      for ii in range (0,p1):
        for jj in range (0,q1):
          for kk in range (0,r1):
            ...
            eps[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bz0[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bz01[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
#proc j to j-1
 if (ipy>0):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_by0[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_by01[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bx0[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bx01[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bx1[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bx10[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_by1[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_by10[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bz1[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bz10[j]+=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
 ...
 if (ipz==NPZ-1) and (NPZ>2):
   ...
   for j in range(nbz01):
       num_string = format(eps_bz01[j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipy==NPY-1) and (NPY>2):
   ...
   for j in range(nby01):
       num_string = format(eps_by01[j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipx==NPX-1) and (NPX>2):
   ...
   for j in range(nbx01):
       num_string = format(eps_bx01[j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipx==0) and (NPX>1):
   ...
   for j in range(nbx10):
       num_string = format(eps_bx10[j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipy==0) and (NPY>1):
   ...
   for j in range(nby10):
       num_string = format(eps_by10[j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipz==0) and (NPZ>1):
   ...
   for j in range(nbz10):
       num_string = format(eps_bz10[j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
