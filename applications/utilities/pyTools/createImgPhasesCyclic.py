...
def main(xDim, yDim, zDim, xMin, xMax, yMin, yMax, zMin, zMax, nX, nY, nZ, Image_name, padWidth, pad_value, value1,value0, phases_value, phases ,dimension,direction, NPX, NPY, NPZ, rank, output_path,field_name):
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             field[i,j,k]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             ...
             field_bz0[i,j] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             a=my_array_p_z01[kk,j*q+jj,i*p+ii]
             field_bz01[i,j] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             field_by0[i,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             a=my_array_p_y01[k*r+kk,jj,i*p+ii]
             field_by01[i,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             field_bx0[j,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
   ...
   for ii in range (0,p):
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             a=my_array_p_x01[k*r+kk,j*q+jj,ii]
             field_bx01[j,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             field_bx1[j,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
   ...
   for ii in range (0,p):
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             a=my_array_p_x10[k*r+kk,j*q+jj,ii]
             field_bx10[j,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             field_by1[i,k]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             a=my_array_p_y10[k*r+kk,jj,i*p+ii]
             field_by10[i,k] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             ...
             field_bz1[i,j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             a=my_array_p_z10[kk,j*q+jj,i*p+ii]
             field_bz10[i,j] +=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p/q/r
