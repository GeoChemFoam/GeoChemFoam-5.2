...
def main(xDim, yDim, zDim, xMin, xMax, yMin, yMax, zMin, zMax, nX, nY, nZ, Image_name, padWidth, pad_value, value1,value0, field_min,dimension,direction, NPX, NPY, NPZ, rank, output_path,field_name):
     ...
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field[i,j,k]+=((my_array_p[k*r+kk,j*q+jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p[k*r+kk,j*q+jj,i*p+ii])/(value1-value0))/p/q/r
 ##get subarray for proc i-1
 field_bx0 =np.zeros((nyp,nzp),dtype="float64")
 ##get subarray for proc right 
 field_bx01 =np.zeros((nyp,nzp),dtype="float64")
 ##get subarray for proc i+1
 field_bx1 =np.zeros((nyp,nzp),dtype="float64")
 ##get subarray for proc left 
 field_bx10 =np.zeros((nyp,nzp),dtype="float64")
 ##get subarray for proc j-1
 field_by0 =np.zeros((nxp,nzp),dtype="float64")
 ##get subarray for proc trhough top 
 field_by01=np.zeros((nxp,nzp),dtype="float64")
 ##get subarray for proc j+1
 field_by1 =np.zeros((nxp,nzp),dtype="float64")
 ##get subarray for proc trhough bottom 
 field_by10=np.zeros((nxp,nzp),dtype="float64")
 ##get subarray for proc k-1
 field_bz0 =np.zeros((nxp,nyp),dtype="float64")
 ##get subarray for proc trhough front 
 field_bz01=np.zeros((nxp,nyp),dtype="float64")
 ##get subarray for proc k-1
 field_bz1 =np.zeros((nxp,nyp),dtype="float64")
 ##get subarray for proc trhough back
 field_bz10=np.zeros((nxp,nyp),dtype="float64")
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             field_bz0[i,j]+=((my_array_p_z0[kk,j*q+jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_z0[kk,j*q+jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             field_bz01[i,j]+=((my_array_p_z01[kk,j*q+jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_z01[kk,j*q+jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_by0[i,k]+=((my_array_p_y0[k*r+kk,jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_y0[k*r+kk,jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_by01[i,k]+=((my_array_p_y01[k*r+kk,jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_y01[k*r+kk,jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for ii in range (0,p):
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_bx0[j,k]+=((my_array_p_x0[k*r+kk,j*q+jj,ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_x0[k*r+kk,j*q+jj,ii])/(value1-value0))/p/q/r
   ...
   for ii in range (0,p):
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_bx01[j,k]+=((my_array_p_x01[k*r+kk,j*q+jj,ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_x01[k*r+kk,j*q+jj,ii])/(value1-value0))/p/q/r
   ...
   for ii in range (0,p):
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_bx1[j,k]+=((my_array_p_x1[k*r+kk,j*q+jj,ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_x1[k*r+kk,j*q+jj,ii])/(value1-value0))/p/q/r
   ...
   for ii in range (0,p):
     for j in range (0,nyp):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_bx10[j,k]+=((my_array_p_x10[k*r+kk,j*q+jj,ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_x10[k*r+kk,j*q+jj,ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_by1[i,k]+=((my_array_p_y1[k*r+kk,jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_y1[k*r+kk,jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             field_by10[i,k]+=((my_array_p_y10[k*r+kk,jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_y10[k*r+kk,jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             field_bz1[i,j]+=((my_array_p_z1[kk,j*q+jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_z1[kk,j*q+jj,i*p+ii])/(value1-value0))/p/q/r
   ...
   for i in range (0,nxp):
     for ii in range (0,p):
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             field_bz10[i,j]+=((my_array_p_z10[kk,j*q+jj,i*p+ii]-value0)/(value1-value0)+ field_min*(value1-my_array_p_z10[kk,j*q+jj,i*p+ii])/(value1-value0))/p/q/r
 ...
 for k in range(nzp):
   for j in range(nyp):
     for i in range(nxp):
       num_string = format(field[i, j, k], ".8f").rstrip('0').rstrip('.')
 ...
 if (ipz==NPZ-1) and (NPZ>2):
   ...
   for i in range(nxp):
     for j in range(nyp):
       num_string = format(field_bz01[i,j],".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipz>0):
   ...
   for j in range(nyp):
     for i in range(nxp):
       num_string = format(field_bz0[i, j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipy==NPY-1) and (NPY>2):
   ...
   for i in range(nxp):
     for k in range(nzp):
       num_string = format(field_by01[i,k],".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipy>0):
   ...
   for k in range(nzp):
     for i in range(nxp):
       num_string = format(field_by0[i, k], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipx==NPX-1) and (NPX>2):
   ...
   for k in range(nzp):
     for j in range(nyp):
       num_string = format(field_bx01[j,k],".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipx>0):
   ...
   for k in range(nzp):
     for j in range(nyp):
       num_string = format(field_bx0[j, k], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipx<NPX-1):
   ...
   for k in range(nzp):
     for j in range(nyp):
       num_string = format(field_bx1[j, k], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipx==0) and (NPX>1):
   ...
   for k in range(nzp):
     for j in range(nyp):
       num_string = format(field_bx10[j,k],".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipy<NPY-1):
   ...
   for k in range(nzp):
     for i in range(nxp):
       num_string = format(field_by1[i, k], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipy==0) and (NPY>1):
   ...
   for i in range(nxp):
     for k in range(nzp):
       num_string = format(field_by10[i,k],".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipz<NPZ-1):
   ...
   for j in range(nyp):
     for i in range(nxp):
       num_string = format(field_bz1[i, j], ".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
 ...
 if (ipz==0) and (NPZ>1):
   ...
   for i in range(nxp):
     for j in range(nyp):
       num_string = format(field_bz10[i,j],".8f").rstrip('0').rstrip('.')
       data.append(f"{num_string}\n")
   data.extend([
   ")\n",
   ";\n",
