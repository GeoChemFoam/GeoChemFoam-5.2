...
def main(xDim, yDim, zDim, xMin, xMax, yMin, yMax, zMin, zMax, nX, nY, nZ, Image_name, padWidth, pad_value, pores_value,solid_value, eps_min,dimension,direction, NPX, NPY, NPZ, rank, output_path):
