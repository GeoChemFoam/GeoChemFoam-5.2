...
def main(xDim, yDim, zDim, xMin, xMax, yMin, yMax, zMin, zMax, nX, nY, nZ, res,Image_name, padWidth, pad_value, pores_value,solid_value, eps_min,dimension,direction, nlevel,refineStokes,NPX, NPY, NPZ, rank, output_path):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             eps_bz01[j]+=((a-solid_value)/(pores_value-solid_value)+ eps_min*(pores_value-a)/(pores_value-solid_value))/p1/q1/r1
#proc j to j-1
 if (ipy>0):
   ...
   for j in range(0,nby01):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             eps_by01[j]+=((my_array_p_y01[iz_by01[j]*r1+kk,jj,ix_by01[j]*p1+ii]-solid_value)/(pores_value-solid_value)+ eps_min*(pores_value-my_array_p_y01[iz_by01[j]*r1+kk,jj,ix_by01[j]*p1+ii])/(pores_value-solid_value))/p1/q1/r1
   ...
   for j in range(0,nbx01):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             eps_bx01[j]+=((my_array_p_x01[iz_bx01[j]*r1+kk,iy_bx01[j]*q1+jj,ii]-solid_value)/(pores_value-solid_value)+ eps_min*(pores_value-my_array_p_x01[iz_bx01[j]*r1+kk,iy_bx01[j]*q1+jj,ii])/(pores_value-solid_value))/p1/q1/r1
   ...
   for j in range(0,nbx10):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             eps_bx10[j]+=((my_array_p_x10[iz_bx10[j]*r1+kk,iy_bx10[j]*q1+jj,ii]-solid_value)/(pores_value-solid_value)+ eps_min*(pores_value-my_array_p_x10[iz_bx10[j]*r1+kk,iy_bx10[j]*q1+jj,ii])/(pores_value-solid_value))/p1/q1/r1
   ...
   for j in range(0,nby10):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
               eps_by10[j]+=((my_array_p_y10[iz_by10[j]*r1+kk,jj,ix_by10[j]*p1+ii]-solid_value)/(pores_value-solid_value)+ eps_min*(pores_value-my_array_p_y10[iz_by10[j]*r1+kk,jj,ix_by10[j]*p1+ii])/(pores_value-solid_value))/p1/q1/r1
   ...
   for j in range(0,nbz10):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
               eps_bz10[j]+=((my_array_p_z10[kk,iy_bz10[j]*q1+jj,ix_bz10[j]*p1+ii]-solid_value)/(pores_value-solid_value)+ eps_min*(pores_value-my_array_p_z10[kk,iy_bz10[j]*q1+jj,ix_bz10[j]*p1+ii])/(pores_value-solid_value))/p1/q1/r1
