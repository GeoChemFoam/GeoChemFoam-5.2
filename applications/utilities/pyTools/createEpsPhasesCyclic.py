       ...
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             ...
             eps_bz01[i,j] +=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             eps_by01[i,k] +=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             eps_bx01[j,k] +=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             eps_bx10[j,k] +=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for jj in range (0,q):
         for k in range (0,nzp):
           for kk in range (0,r):
             ...
             eps_by10[i,k] +=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p/q/r
       ...
       for j in range (0,nyp):
         for jj in range (0,q):
           for kk in range (0,r):
             ...
             eps_bz10[i,j] +=float(micro_por_array[np.squeeze(np.where(phases_array==a))])/p/q/r
