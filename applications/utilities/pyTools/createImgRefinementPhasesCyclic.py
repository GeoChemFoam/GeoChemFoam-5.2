...
def main(xDim, yDim, zDim, xMin, xMax, yMin, yMax, zMin, zMax, nX, nY, nZ, res,Image_name, padWidth, pad_value, value1, value0, phases_value, phases ,dimension,direction, nlevel,NPX, NPY, NPZ, rank, output_path,field_name):

 #start_time = time.time()
 
 phases_value_array = phases_value.split(',')
 phases_array = [int(x) for x in phases.split(',')]
 nlist=len(phases_value_array)
 poro=np.float64(sorted(phases_value_array,key=float))
 ...
 for j in range(0,n):
    fieldVal=field[j]
    is_refined=0
    for k in range(0,nlist-1):
     if (fieldVal<poro[k+1]-(poro[k+1]-poro[k])*5e-3) and (fieldVal> poro[k]+(poro[k+1]-poro[k])*5e-3):
       is_refined=1
    if (is_refined):
      field[j]=0
      for ii in range (0,p1):
        for jj in range (0,q1):
          for kk in range (0,r1):
            a=my_array_p[iz[j]*r1+kk,iy[j]*q1+jj,ix[j]*p1+ii]
            field[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbz0):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_z0[kk,iy_bz0[j]*q1+jj,ix_bz0[j]*p1+ii]
             field_bz0[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             ...
             field_bz01[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
#proc j to j-1
 if (ipy>0):
   for j in range(0,nby0):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_y0[iz_by0[j]*r1+kk,jj,ix_by0[j]*p1+ii]
             field_by0[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nby01):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_y01[iz_by01[j]*r1+kk,jj,ix_by01[j]*p1+ii]
             field_by01[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbx0):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_x0[iz_bx0[j]*r1+kk,iy_bx0[j]*q1+jj,ii]
             field_bx0[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbx01):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_x01[iz_bx01[j]*r1+kk,iy_bx01[j]*q1+jj,ii]
             field_bx01[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbx1):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_x1[iz_bx1[j]*r1+kk,iy_bx1[j]*q1+jj,ii]
             field_bx1[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbx10):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_x10[iz_bx10[j]*r1+kk,iy_bx10[j]*q1+jj,ii]
             field_bx10[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nby1):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_y1[iz_by1[j]*r1+kk,jj,ix_by1[j]*p1+ii]
             field_by1[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nby10):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_y10[iz_by10[j]*r1+kk,jj,ix_by10[j]*p1+ii]
             field_by10[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbz1):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_z1[kk,iy_bz1[j]*q1+jj,ix_bz1[j]*p1+ii]
             field_bz1[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
   ...
   for j in range(0,nbz10):
     ...
     if (is_refined):
       ...
       for ii in range (0,p1):
         for jj in range (0,q1):
           for kk in range (0,r1):
             a=my_array_p_z10[kk,iy_bz10[j]*q1+jj,ix_bz10[j]*p1+ii]
             field_bz10[j]+=float(phases_value_array[np.squeeze(np.where(phases_array==a))])/p1/q1/r1
