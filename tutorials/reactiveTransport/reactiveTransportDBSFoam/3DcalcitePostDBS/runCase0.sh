...
then
    ...
    if [[ "${PLATFORM}" == "ARCHER2" ]]; then
        ...
        srun python $GCFOAM_DIR/applications/utilities/pyTools/moveResultTo0.py "U" "p" "phi" "C" "R"
        ...
        echo -e "move 1e-06 to 0"
        mpirun -np $NP python $GCFOAM_DIR/applications/utilities/pyTools/moveResultTo0.py "U" "p" "phi" "C" "R"
    fi
