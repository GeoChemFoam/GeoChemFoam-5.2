...
{
    // Check if 'value' is specified in the dictionary
    if (dict.found("value"))
    {
        // Read and assign the given value
        fvPatchVectorField::operator=(vectorField("value", dict, p.size()));

        // Compute the gradient corresponding to that value
        // Typical definition for fixedGradient type:
        // grad = (value - patchInternalField()) / patch.deltaCoeffs()
        gradient() = ( *this - patchInternalField() ) * patch().deltaCoeffs();
    }
    else
    {
